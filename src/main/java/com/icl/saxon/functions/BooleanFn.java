...
public class BooleanFn extends Function {
    ...
    */
    ...
    public Expression simplify() throws XPathException {
        ...
        if (argument[0].getDataType()==Value.BOOLEAN) {
            return argument[0];
        }
        if (argument[0] instanceof Value) {
            return new BooleanValue(((Value)argument[0]).asBoolean());
        }
        return this;
    }
    ...
    */
    ...
    public boolean evaluateAsBoolean(Context c) throws XPathException {
        return argument[0].evaluateAsBoolean(c);
    }
